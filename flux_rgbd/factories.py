...
def flux_rgbd_9b_v1() -> tuple[FluxRGBD, DepthConfig, ScheduleConfig]:
    ...
    dit = FluxRGBDDiT(
        in_channels=128, depth_channels=256, context_in_dim=12_288,
        hidden_size=4096, num_heads=32,
        depth_double=8, depth_single=24, depth_decoder_num_layers=4,
        axes_dim=(32, 32, 32, 32), theta=2000, mlp_ratio=3.0,
    )
    return (
        FluxRGBD(dit),
