...
def main() -> int:
    ...
    p.add_argument("--edge-rtol", type=float, default=0.04,
    ...
    n, cloud_paths = write_point_cloud(
        result["rgb"], result["depth"], glb,
        fov_deg=args.fov_deg, edge_rtol=args.edge_rtol, sor=args.sor)
